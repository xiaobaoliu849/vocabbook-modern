     ...
     const handleImport = async () => {
         ...
         try {
             ...
             if (activeTab === 'file') {
                 ...
                 // formData.append('auto_lookup', String(autoLookup)) // FastAPI expects query params for non-file fields in UploadFile endpoint usually, but let's check backend
                 // Checked backend: auto_lookup and tag are query params
                         ...
                         >
                             ...
                             {file ? (
                                 <div className="flex flex-col items-center gap-2">
                                     {file.name.endsWith('.csv') ? <FileSpreadsheet size={48} className="text-green-500" /> : <FileText size={48} className="text-primary-500" />}
