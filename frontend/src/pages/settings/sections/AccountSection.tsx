    ...
    if (!user) {
        return (
            <div className="space-y-6">
                <div>
                    <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2">账户</h3>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">管理您的账户信息和会员状态</p>
                </div>
        ...
        <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 p-6">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-slate-800 dark:text-white">云同步</h4>
                        <p className="text-xs text-green-600 dark:text-green-400">已连接</p>
                    </div>
                </div>
                <p className="text-sm text-slate-500 dark:text-slate-400">
                    您的生词本数据已自动同步至云端，可在其他设备登录同一账户访问。
                </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 p-6">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-slate-800 dark:text-white">当前设备</h4>
                        <p className="text-xs text-slate-500 dark:text-slate-400">桌面应用</p>
                    </div>
                </div>
                <p className="text-sm text-slate-500 dark:text-slate-400">
                    此设备已登录您的账户，数据将实时同步。
